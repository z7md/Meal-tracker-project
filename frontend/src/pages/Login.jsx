...
export default function Login() {
  ...
  let p;
  if(!correct)
  p = <p className="right-0 text-red-700 text-[16px]">Wrong Password or Email </p>
      ...
      await axios
        ...
        .then((res) => {
          if (res.data == "notexist") {
            ...
            history("/home", { state: { id: res.data._id } });
          }
        })
        .catch((e) => {
          alert("wrong details");
  ...
  return (
    ...
    <form action="POST" className="flex flex-col">
        ...
        <Link to="/signup" className="mt-2 text-gray-400 hover:underline text-bold font-medium  hover:scale-110">Create an account</Link>
